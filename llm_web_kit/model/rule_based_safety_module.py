...
class RuleBasedSafetyModule:
    ...
    def process_core(self, data_pack: RuleBasedSafetyModuleDataPack) -> RuleBasedSafetyModuleDataPack:
        ...
        source_type_dict=self.source_filter.filter(content_str, language, content_style)
        from_safe_source=source_type_dict["from_safe_source"]
        from_domestic_source=source_type_dict["from_domestic_source"]
        remained, process_info = self.unsafe_words_filter.filter(
            content_str, language, language_details, content_style,from_safe_source,from_domestic_source
        )
